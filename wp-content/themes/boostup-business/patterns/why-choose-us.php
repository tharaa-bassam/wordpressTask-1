<?php
 /**
  * Title: Why Choose Us
  * Slug: boostup-business/why-choose-us
...
<div class="wp-block-group alignfull has-background-secondary-background-color has-background" style="padding-top:100px;padding-right:30px;padding-bottom:100px;padding-left:30px"><!-- wp:columns {"verticalAlignment":"center","align":"wide","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|70","left":"var:preset|spacing|70"}}}} -->
  ...
  <div class="wp-block-column is-vertically-aligned-center"><!-- wp:image {"id":52,"aspectRatio":"1","scale":"cover","sizeSlug":"full","linkDestination":"none"} -->
  <figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/why-choose-us.jpg" alt="" class="wp-image-52" style="aspect-ratio:1;object-fit:cover"/></figure>
  <!-- /wp:image --></div>
  <!-- /wp:column -->
  ...
  <p class="has-primary-color has-text-color"><?php echo esc_html__( 'Why Choose Us?', 'boostup-business' ); ?></p>
  <!-- /wp:paragraph -->
  
  <!-- wp:heading {"fontSize":"large"} -->
  <h2 class="wp-block-heading has-large-font-size"><?php echo esc_html__( 'Innovative Business Ideas and Brainstorming', 'boostup-business' ); ?></h2>
  <!-- /wp:heading -->
  
  <!-- wp:paragraph -->
  <p><?php echo esc_html__( 'Lorem ipsum dolor sit amet consectetur adipiscing elit cras proin rhoncus habitant pharetra, potenti senectus nostra metus ac blandit integer iaculis scelerisque arcu malesuada. Tortor quis sagittis risus est egestas commodo', 'boostup-business' ); ?></p>
  <!-- /wp:paragraph -->
  
  <!-- wp:paragraph -->
  <p><?php echo esc_html__( 'Lorem ipsum dolor sit amet consectetur adipiscing elit cras proin rhoncus habitant pharetra, potenti senectus nostra metus ac blandit integer iaculis scelerisque', 'boostup-business' ); ?></p>
  <!-- /wp:paragraph -->
  ...
  <div class="wp-block-button"><a class="wp-block-button__link wp-element-button"><?php echo esc_html__( 'Discover More', 'boostup-business' ); ?></a></div>
  <!-- /wp:button --></div>
  <!-- /wp:buttons --></div>
  <!-- /wp:group --></div>
  <!-- /wp:group --></div>
