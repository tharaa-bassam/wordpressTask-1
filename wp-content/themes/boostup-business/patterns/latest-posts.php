...
/**
 * Title: Latest News
 * Slug: boostup-business/latest-posts
...
<p class="has-text-align-center has-primary-color has-text-color"><?php echo esc_html__( 'Latest Posts', 'boostup-business' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"center","fontSize":"main-title"} -->
<h2 class="wp-block-heading has-text-align-center has-main-title-font-size"><?php echo esc_html__( 'Our Latest Blog', 'boostup-business' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link wp-element-button" href="#"><?php echo esc_html__( 'View All', 'boostup-business' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->